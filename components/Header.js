Vue.component('app-header', {
  template: `
    <header class="fixed w-full top-0 z-50">
      <div class="bg-[#0D1B2A]/80 backdrop-blur-lg shadow-lg border-b border-gray-700">
        ...
        <div v-if="isDefinitelyLoggedOut" class="container mx-auto px-4 py-3">
        ...
        <div v-if="isDefinitelyLoggedIn" class="container mx-auto px-4 py-3">
        ...
        <div v-if="$root.isLoading" class="container mx-auto px-4 py-3">
  ...
  methods: {
    ...
    async handleSignOut() {
      try {
        this.$root.isLoading = true; // Start loading state
        
        // Make API call to logout
        await fetch('/components/Header.php', {
          method: 'POST',
          headers: {
        ...
        this.$root.isLoading = false; // Make sure to end loading state even on error
      }
    },
    closeUserMenu() {
      this.isUserMenuOpen = false;
